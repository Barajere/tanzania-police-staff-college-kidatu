          ...
          <div className="row g-3 library-wrapper">
            ...
            <div className="col-lg-5">
              ...
              <p className="library-text">
                The TPSC Library is a comprehensive knowledge hub. Every section is carefully curated to provide students, researchers, and faculty members with easy access to materials for study, projects, and academic research.
              </p>
